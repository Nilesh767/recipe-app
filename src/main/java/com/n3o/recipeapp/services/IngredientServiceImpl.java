...
import com.n3o.recipeapp.converters.IngredientCommandToIngredient;
...
public class IngredientServiceImpl implements IngredientService {
    ...
    public IngredientCommand findByRecipeIdAndIngredientId(Long recipeId, Long ingredientId) {
        ...
        if(!ingredientCommandOptional.isPresent()) log.error("Ingredient Id not Found:"+ ingredientId);
